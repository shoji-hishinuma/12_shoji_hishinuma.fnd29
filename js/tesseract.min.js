	...
	return (function (e) {
					...
					function a(t, a) {
						a && console.log(a),
							t && i.isInstanceOf("Blob", t)
								...
								: ((n = e), r && r.crossOrigin && (o.crossOrigin = r.crossOrigin)),
							(o.src = n);
					}
					return (
								...
								(e.blobSlice =
													...
													if (65496 === f.getUint16(0)) {
														...
														!n.disableImageHead &&
															...
															(l.slice
																...
																: (o.imageHead = new Uint8Array(l).subarray(0, h)));
									...
									(e.replaceHead = function (t, r, n) {
										e.parseMetaData(
											t,
											function (o) {
												n(new Blob([r, e.blobSlice.call(t, o.imageHead.byteLength)], { type: "image/jpeg" }));
											},
		...
		function (e, t, r) {
			...
			e.exports = function () {
				...
				var E = function (e, t) {
					...
					j = function (e) {
						...
						return new Promise(function (e, i) {
							p("[".concat(t, "]: Start ").concat(r, ", action=").concat(n)),
								E(n, e),
								P(n, i),
								x(A, { workerId: t, jobId: r, action: n, payload: o });
						});
					},
					k = function (e) {
					...
					D = function (e, t, r) {
						return j(f({ id: r, action: "FS", payload: { method: "writeFile", args: [e, t] } }));
					},
					L = function (e, t) {
						return j(f({ id: t, action: "FS", payload: { method: "readFile", args: [e, { encoding: "utf8" }] } }));
					},
					I = function (e, t) {
						return j(f({ id: t, action: "FS", payload: { method: "unlink", args: [e] } }));
					},
					R = function (e, t, r) {
						return j(f({ id: r, action: "FS", payload: { method: e, args: t } }));
					},
					C = function () {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
							t = arguments.length > 1 ? arguments[1] : void 0;
						return j(f({ id: t, action: "loadLanguage", payload: { langs: e, options: c } }));
					},
					T = function () {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
							t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h,
							r = arguments.length > 2 ? arguments[2] : void 0;
						return j(f({ id: r, action: "initialize", payload: { langs: e, oem: t } }));
					},
					B = function () {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
							t = arguments.length > 1 ? arguments[1] : void 0;
						return j(f({ id: t, action: "setParameters", payload: { params: e } }));
					},
					F = (function () {
						var e = o(
					...
					M = function () {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Tesseract OCR Result",
							...
							r = arguments.length > 2 ? arguments[2] : void 0;
						return j(f({ id: r, action: "getPDF", payload: { title: e, textonly: t } }));
					},
					U = (function () {
						var e = o(
										...
										switch ((e.prev = e.next)) {
											...
											case 5:
												return (
													(e.t3 = e.sent),
													(e.t4 = { image: e.t3 }),
													(e.t5 = { id: e.t2, action: "detect", payload: e.t4 }),
													(e.t6 = (0, e.t1)(e.t5)),
							...
							regeneratorRuntime.mark(function e() {
								return regeneratorRuntime.wrap(function (e) {
									for (;;)
										switch ((e.prev = e.next)) {
											case 0:
												return null !== A && (b(A), (A = null)), e.abrupt("return", Promise.resolve());
											case 2:
											case "end":
												return e.stop();
										}
				...
				return (
					v(A, function (e) {
						...
						if ("resolve" === o) {
							...
							"recognize" === c
								? (u = l(s))
								: "getPDF" === c && (u = Array.from(a({}, s, { length: Object.keys(s).length }))),
								g[c]({ jobId: r, data: u });
						} else if ("reject" === o) {
							if ((S[c](s), !i)) throw Error(s);
							i(s);
						} else "progress" === o && n(s);
					}),
					{
							...
							typeof (n = function (e) {
								...
								(e.transform = function (r, n, o, i, a) {
									...
									(e.getTransformedOptions = function (e, t) {
										...
										return (
											(r.crop = !0),
											(o = e.naturalWidth || e.width) / (i = e.naturalHeight || e.height) > a
									...
									(e.renderImageToCanvas = function (e, t, r, n, o, i, a, c, s, u, l) {
										...
										return (
											!1 === l.imageSmoothingEnabled
												...
												: l.imageSmoothingQuality && (f.imageSmoothingQuality = l.imageSmoothingQuality),
									...
									(e.scale = function (t, r, n) {
										...
										if (
											(m &&
												...
												(f = r.top || 0),
												r.sourceWidth
													? ((s = r.sourceWidth), void 0 !== r.right && void 0 === r.left && (l = y - s - r.right))
													: (s = y - l - (r.right || 0)),
												r.sourceHeight
													? ((u = r.sourceHeight), void 0 !== r.bottom && void 0 === r.top && (f = b - u - r.bottom))
													: (u = b - f - (r.bottom || 0)),
												(v = s),
												(w = u)),
											(o = r.maxWidth),
											...
											m && o && i && r.crop
												? ((v = o),
												  (w = i),
												  (h = s / u - o / i) < 0
														? ((u = (i * s) / o), void 0 === r.top && void 0 === r.bottom && (f = (b - u) / 2))
														: h > 0 &&
														  ((s = (o * u) / i), void 0 === r.left && void 0 === r.right && (l = (y - s) / 2)))
												: ((r.contain || r.cover) && ((a = o = o || a), (c = i = i || c)),
												  r.cover ? (O(), x()) : (x(), O())),
											m)
										) {
											if (
												...
												(d = r.downsamplingRatio) > 0 && d < 1 && v < s && w < u)
											)
												for (; s * d > v; )
													(g.width = s * d),
														(g.height = u * d),
														e.renderImageToCanvas(g, t, l, f, s, u, 0, 0, g.width, g.height, r),
														(l = 0),
														(f = 0),
														(s = g.width),
														(u = g.height),
														...
														(t.height = u),
														e.renderImageToCanvas(t, g, 0, 0, s, u, 0, 0, s, u, r);
											return (
												(g.width = v),
												(g.height = w),
					...
					void 0 ===
						(i =
							...
							typeof (n = function (e) {
								function t(e) {
									e &&
										(Object.defineProperty(this, "map", { value: this.privateIFDs[e].map }),
										Object.defineProperty(this, "tags", { value: (this.tags && this.tags[e]) || {} }));
								}
								(t.prototype.map = {
									Orientation: 274,
									Thumbnail: 513,
										...
										if (!((l = r + 2 + 12 * (u = e.getUint16(r, o))) + 4 > e.byteLength)) {
											for (f = 0; f < u; f += 1)
												(p = r + 2 + 12 * f),
													...
													(c && !c[d]) ||
														(s && !0 === s[d]) ||
														((h = n(e, t, p, e.getUint16(p + 2, o), e.getUint32(p + 4, o), o)),
														(i[d] = h),
														a && (a[d] = p));
													...
													42 === e.getUint16(f + 2, c)
														? ((s = e.getUint32(f + 4, c)),
														  ...
														  a.disableExifOffsets ||
																((i.exifOffsets = new t()), (i.exifTiffOffset = f), (i.exifLittleEndian = c)),
														  (s = o(e, f, f + s, c, i.exif, i.exifOffsets, u, l)) &&
																...
																i.exif[513] &&
																	...
																	(i.exif[513] = (function (e, t, r) {
																		if (r && !(t + r > e.byteLength))
																			return new Blob([e.buffer.slice(t, t + r)], { type: "image/jpeg" });
																		console.log("Invalid Exif data: Invalid thumbnail data.");
																	})(e, f + i.exif[513], i.exif[514]))),
														  Object.keys(i.exif.privateIFDs).forEach(function (r) {
																!(function (e, r, n, i, a, c, s) {
																	var u = e.exif[r];
																	u &&
																		((e.exif[r] = new t(r)),
																		e.exifOffsets && (e.exifOffsets[r] = new t(r)),
																		o(
																			n,
																			i,
																			i + u,
						...
						(i =
							...
							typeof (n = function (e) {
								...
								(t.prototype.map = { ObjectName: 5 }),
									(t.prototype.types = { 0: "Uint16", 200: "Uint16", 201: "Uint16", 202: "binary" }),
									(t.prototype.get = function (e) {
										return this[e] || this[this.map[e]];
									}),
											...
											for (var u = r + n; r + 8 < u; ) {
												if (i(e, r)) {
													...
													return (
														...
														void o(e, f, p, c, s.includeIptcTags, s.excludeIptcTags || { 202: !0 })
													);
												}
												r += 1;
											}
		...
		function (e, t, r) {
			...
			e.exports = (function (e) {
				...
				return e;
			})({ OEM: s, PSM: u, createScheduler: i, createWorker: a, setLogging: l }, c);
		},
		function (e, t, r) {
			(function (e) {
				function t(e) {
						...
						(S.prototype = {
							...
							finish: function (e) {
								for (var t = this.tryEntries.length - 1; t >= 0; --t) {
									...
									if (r.finallyLoc === e) return this.complete(r.completion, r.afterLoc), O(r), l;
								}
							},
							catch: function (e) {
								for (var t = this.tryEntries.length - 1; t >= 0; --t) {
		...
		function (e, t, r) {
			var n = r(22),
				...
				c = r(28),
				s = r(29);
			e.exports = { defaultOptions: n, spawnWorker: o, terminateWorker: i, onMessage: a, send: c, loadImage: s };
		},
		function (e, t, r) {
			(function (t) {
				function n(e) {
				...
				e.exports = (function (e) {
					...
					workerPath:
						void 0 !== t && "development" === t.env.TESS_ENV
							...
							: "https://unpkg.com/tesseract.js@v".concat(s, "/dist/worker.min.js"),
					corePath: "https://unpkg.com/tesseract.js-core@v"
						.concat(u["tesseract.js-core"].substring(1), "/tesseract-core.")
						.concat(
							"object" === ("undefined" == typeof WebAssembly ? "undefined" : n(WebAssembly)) ? "wasm" : "asm",
							".js"
						),
				});
			}).call(this, r(4));
								...
								for (;;)
									switch ((e.prev = e.next)) {
										...
										case 13:
											return (
												(a = t),
												/data:image\/([a-zA-Z]*);base64,([^"]*)/.test(t) || (a = i(t)),
												(e.t0 = c),
												(e.next = 18),
												s(a)
											);
								...
								(t.tags = {
									...
									(t.getAll = function () {
										var e,
											...
											r = {};
										for (e in this)
											Object.prototype.hasOwnProperty.call(this, e) && (t = this.tags[e]) && (r[t] = this.getText(t));
										return r;
									}),
									(t.getName = function (e) {
										return this.tags[e];
							...
							typeof (n = function (e) {
								...
								(i = document.createElement("img")),
									...
									(e.transformCoordinates = function (t, r) {
										...
										if (u > 1 && u < 9)
											switch (
												(u > 4 && ((t.width = a), (t.height = i), (t.style.width = s), (t.style.height = c)), u)
											) {
												case 2:
												...
												case 6:
													...
													break;
												case 7:
													o.rotate(0.5 * Math.PI), o.translate(i, -a), o.scale(-1, 1);
													break;
												case 8:
